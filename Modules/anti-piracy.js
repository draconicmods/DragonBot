...
const embed = new Discord.RichEmbed()
  ...
  .addField('DraconicMods Server Rule Violation', 'Please be aware that discussion of piracy or organizations promoting piracy is against the server rules and may result in a ban on repeated offences.')
  //.addBlankField()
