...
const embed = new Discord.RichEmbed()
  ...
  .addField('DraconicMods Server Rule Violation', 'Please be aware that discussion of piracy, organizations promoting piracy, discussions of CFW and organizations promoting CFW are against the server rules and may result in a ban on repeated offences.')
  //.addBlankField()
  .setTimestamp()
